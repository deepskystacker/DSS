...
public:
	const QString GetStartText() const override { return QString{}; }
	const QString GetStart2Text() const override { return QString{}; }
	void Start(const QString&, int lTotal1, bool bEnableCancel = true) override {}
	void Progress1(const QString&, int lAchieved1) override {}
	void Start2(const QString&, int lTotal2) override {
		++nrCallsStart2;
		argumentStart2 = lTotal2;
	}
	void Progress2(const QString&, int lAchieved2) override {
		++nrCallsProgress2;
