...
{
	return BackgroundCalibrationInterface::makeBackgroundCalibrator<1>(pBitmap->BitPerSample(), pBitmap->IsIntegralType())->calculateModelParameters(*pBitmap, false) / 256.0;
}
