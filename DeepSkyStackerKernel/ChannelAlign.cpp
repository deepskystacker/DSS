...
// static
std::shared_ptr<CMemoryBitmap> CChannelAlign::AlignChannel(const CMemoryBitmap* pBitmap, const CPixelTransform& PixTransform, DSS::OldProgressBase* pProgress)
{
	ZFUNCTRACE_RUNTIME();
...
// static
bool CChannelAlign::AlignChannels(std::shared_ptr<CMemoryBitmap> pBitmap, DSS::OldProgressBase* pProgress)
{
	ZFUNCTRACE_RUNTIME();
