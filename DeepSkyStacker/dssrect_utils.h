...
namespace DSS {
	...
	//
	bool pointIsInRect(const QPointF& point, const double rectleft, const double recttop, const double rectright, const double rectbottom) noexcept
	{
	...
	//
	bool blockContainsPixel(const DSSRect& block, const QPoint& pixel) noexcept
	{
